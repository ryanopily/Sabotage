...
public class Permissions {
	...
	public static final String 
		DEFAULT       = "zerodasho.sabotage.generic",
		SAB_PAUSE     = "zerodasho.sabotage.generic.pause",
		SAB_START     = "zerodasho.sabotage.generic.start",
		...
		NO_DAMAGE     = "zerodasho.sabotage.attributes.nodamage";
}
